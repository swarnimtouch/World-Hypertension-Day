...
<div class="card login-card">
    <div class="card-header bg-transparent px-4 pt-4 pb-0 text-center">
        ...
        <img src="{{ asset('images/hypertension day logo.jpg') }}" alt="Logo" class="logo mb-2"
    ...
    <div class="card-body p-4">
        ...
        @if ($errors->any())
            <div class="alert alert-danger py-2 px-3 text-center"
                 style="font-size: 14px; border-radius: 10px; font-weight: 600;" role="alert">
                {{ $errors->first() }}
            </div>
        @endif
