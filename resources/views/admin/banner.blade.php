...
@section('content')
    ...
    <div class="filter-bar">
        <div class="search-wrap">
            ...
            <input type="text" id="customSearchBox" class="filter-input" placeholder="Search Banners..." autocomplete="off">
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-btns">
                                    <a href="{{ $emp->banner_path }}" class="act-btn banner-btn download-link" title="Download Banner">
